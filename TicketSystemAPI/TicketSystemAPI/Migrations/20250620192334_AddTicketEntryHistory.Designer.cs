...
namespace TicketSystemAPI.Migrations
{
    ...
    [Migration("20250620192334_AddTicketEntryHistory")]
    partial class AddTicketEntryHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TicketSystemAPI.Models.Efmigrationshistory", b =>
                {
            ...
            modelBuilder.Entity("TicketSystemAPI.Models.TicketEntryHistory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasIndex(new[] { "TicketId" }, "fk_TicketEntryHistory_Tickets");

                    b.ToTable("ticket_entry_history", (string)null);
            ...
            modelBuilder.Entity("TicketSystemAPI.Models.TicketEntryHistory", b =>
                {
                    b.HasOne("TicketSystemAPI.Models.Ticket", "Ticket")
                        .WithMany("EntryHistory")
